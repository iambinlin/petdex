...
export function ClaimCTA({
  ...
  const inner = (
    <span className="inline-flex items-center gap-1.5 rounded-full bg-black px-3 text-xs font-medium text-white transition hover:bg-black/85">
      Sign in to claim
  ...
  return (
    <aside className="mt-3 flex flex-wrap items-center gap-3 rounded-2xl border border-amber-200 bg-amber-50/70 p-3 text-sm text-amber-900">

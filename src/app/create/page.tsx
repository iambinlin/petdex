...
export default function CreatePage() {
  return (
    <main className="petdex-cloud relative min-h-screen overflow-hidden bg-[#f7f8ff] text-[#050505]">
      <section className="relative mx-auto flex w-full max-w-5xl flex-col gap-10 px-5 py-5 pb-12 md:px-8 md:py-5 md:pb-16">
        ...
        <div className="rounded-3xl border border-black/10 bg-white/76 p-6 backdrop-blur md:p-8">
        ...
        <div className="flex flex-wrap items-center justify-between gap-4 rounded-3xl border border-black/10 bg-white/85 p-6 backdrop-blur">
          <div>
...
function Step({
  ...
  return (
    <li className="flex flex-col gap-2 rounded-3xl border border-black/10 bg-white/76 p-5 backdrop-blur">
      <div className="flex items-center gap-2">
        <span className="grid size-6 place-items-center rounded-full bg-black font-mono text-[11px] text-white">
          {n}
        </span>
        <span className="inline-flex items-center gap-1.5 text-sm font-semibold tracking-tight text-stone-950">
          {icon}
          {title}
        </span>
      </div>

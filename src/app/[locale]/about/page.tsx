      ...
      <section className="mx-auto flex w-full max-w-3xl flex-col gap-12 px-5 py-14 md:px-8 md:py-20">
        <div className="space-y-4">
          ...
          <p className="text-base leading-7 text-muted-2 md:text-lg">
            Petdex is a public, open-source registry. Every entry is a pet pack
            — a tiny bundle of metadata and pixel art that the Codex CLI knows
            how to display while you work. Think of it as a Pokédex for terminal
            companions.
          </p>
          <p className="text-base leading-7 text-muted-2 md:text-lg">
